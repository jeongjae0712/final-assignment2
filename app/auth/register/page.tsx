                ...
                <div className="space-y-2 pt-1">
                  <label className="flex items-start gap-2 cursor-pointer">
                    ...
                    <span className="text-xs text-gray-700 leading-relaxed">
                      <Link href="/terms" target="_blank" className="text-blue-600 font-medium hover:underline">이용약관</Link>에 동의합니다. (필수)
                    </span>
                  </label>
                  <label className="flex items-start gap-2 cursor-pointer">
                    <input
                    ...
                    />
                    <span className="text-xs text-gray-700 leading-relaxed">
                      <Link href="/privacy" target="_blank" className="text-blue-600 font-medium hover:underline">개인정보처리방침</Link>에 동의합니다. (필수)
                    </span>
                  </label>
                </div>
              </>
